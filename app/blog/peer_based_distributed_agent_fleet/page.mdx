import { Terminal } from '~/mdx-components';

export const metadata = {
  title: 'The Rise of the Peer-based "Distributed" Agent Fleet',
  openGraph: {
    images: [{ url: '/PeerCloud.png' }],
  },
};
...
<Terminal lines={["Let's talk about https://www.dillonmrose.com/blog/peer_based_distributed_agent_fleet", "Explain to me ___.","What does he mean when he says ____.", "Ok, let's build it."]} />
